...
function cleanUp() {
  helper.cleanUp([
    ...
    'multiTargets/Gruntfile_dev.js.bak',
  ]);
}
...
exports.reloadgruntfile = {
  setUp: function(done) {
    ...
    backupGrunfile = grunt.file.read(path.join(fixtures, 'multiTargets', 'Gruntfile_dev.js'));
    grunt.file.write(path.join(fixtures, 'multiTargets', 'Gruntfile_dev.js.bak'), backupGrunfile);
    done();
  },
  tearDown: function(done) {
    grunt.file.write(path.join(fixtures, 'multiTargets', 'Gruntfile_dev.js'), backupGrunfile);
    cleanUp();
    done();
  },
  reloadgruntfile: function(test) {
    ...
    assertWatch([function() {
      ...
      grunt.file.write(path.join(cwd, 'Gruntfile_dev.js'), gruntfile);
    }, function() {
