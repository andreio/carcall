...
var optlist = cli.optlist = {
  ...
  gruntfile: {
    info: 'Specify an alternate Gruntfile. By default, grunt looks in the current or parent directories for the nearest Gruntfile_dev.js or Gruntfile.coffee file.',
    type: path
  },
  debug: {
    short: 'd',
